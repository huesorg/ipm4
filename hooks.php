...
function getEndOfTransmission() {
	...
	<div id="endOfTransmission">
		<p>
			...
			<strong>+ <a href="https://patreon.com/killermann" target="_blank" title="My Bosses on Patreon">My <?php the_field('author_patron_count', 'option')?> Bosses.</a></strong></span>
			Pay part of my salary to fund more work like this: <a href="https://bemyboss.es" title="Be Sam Killermann's Boss(es)">Be My Boss</a>.
		</p>
	</div>
