...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts-dist.js', array( 'jquery' ), '', true );
...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'support-nav' => __( 'Support Menu', 'bonestheme' ), // the "kitchen sink" sitemap in header
...
// the dropdown menu
function ipm_support_menu() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menu',           // class of container (should you choose to use it)
    	'menu' => __( 'Support Menu', 'bonestheme' ),  // nav name
    	'menu_class' => 'nav support-nav',         // adding custom nav class
    	'theme_location' => 'support-nav',           	// where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
